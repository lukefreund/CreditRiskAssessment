...
def data_preprocessing(data):
    ...
    return pd.get_dummies(data, columns=['person_home_ownership', 'loan_intent', 'cb_person_default_on_file'],
                          drop_first=True)
...
def scale_features(data):
    ...
    numerical_cols = numerical_cols.drop('loan_status')  # Exclude 'loan_status' from scaling
